    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          {/* Cartoon Characters */}
          <div className="relative flex justify-center items-end" style={{ width: '100%', height: '400px' }}>
            <div className="relative" style={{ width: '550px', height: '100%', left: '-50px' }}>
      ...
      <div className="flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-[420px] lg:max-w-[500px] glass-panel hover-glow p-8 md:p-10 rounded-3xl border border-border/50 shadow-2xl backdrop-blur-lg bg-background/60">
          {/* Mobile Logo */}
          ...
          {/* Children render the form inside */}
          {children}
