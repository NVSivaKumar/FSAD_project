...
const FeatureCard = ({ icon: Icon, title, description, delay }) => (
    <div className={`glass-panel p-8 flex flex-col items-center text-center delay-${delay} animate-fade-in hover:-translate-y-2 transition-transform duration-300`}>
        <div className="w-16 h-16 rounded-full bg-green-500/10 flex items-center justify-center mb-6 border border-green-500/20 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
            ...
            <div className="container mx-auto relative z-10" style={{ marginTop: '10rem' }}>
                <div className="text-center" style={{ marginBottom: '4rem' }}>
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
                        Master Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-600">Trajectory</span>
                    </h2>
                ...
                <div className="glass-panel p-16 md:p-24 rounded-3xl border border-green-500/20 relative flex flex-col items-center text-center overflow-hidden" style={{ marginBottom: '8rem' }}>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                            <Link to="/explore" className="btn-primary px-10 py-5 text-xl inline-flex items-center gap-3 shadow-[0_0_20px_rgba(16,185,129,0.4)]">
